...
>
> Calibrée et testée sur les 14 profils de [[Gondor_et_Fiefs]], puis sur les rosters **Rohan** (9 profils, validés) et **Khand** (5 profils, validés et clos) comme deuxième et troisième points de calibrage. Le roster **Mordor** (`02 - Factions/Mordor.md`, validé et clos, D036) sert de quatrième point de calibrage — première application réelle de la règle hybride [Horde] et de la règle de moral [Peur X].
...
**Encore ouvert :**
1. **Généralisation des unités composites** — aucune unité composite de type Compagnie Grise dans les rosters Rohan, Khand ou Mordor. Reste à surveiller pour Harad et Easterling.
...
5. **Compromis PV/règle de l'Aurige de Khand** (PV 3 + [Poursuite 1]) — chiffré mais jamais testé en partie réelle, à surveiller en priorité au Playtest #1.

---

## 7. Prochaine étape

Les rosters Gondor, Rohan et Khand étant rédigés et validés, et le roster Mordor en cours de repasse (`02 - Factions/Mordor.md`), ce système a servi de quatre points de calibrage cohérents — voir §4. Reste à l'appliquer à Harad et Easterling, et à valider l'ensemble (notamment [Horde] et [Peur X], jamais testés en partie réelle) au Playtest #1 puis au Playtest #3 (scénario Pelennor complet).

---

*Version : 0.6 — Phase 1 (contenu Phase 3 anticipé) — 2026-07-20. Ajout de la ligne de coût [Peur X] (2×X, provisoire, D033) et de sa note associée. Quatrième point de calibrage du système de points effectué sur le roster Mordor en cours de repasse (`02 - Factions/Mordor.md`) — première application réelle du coût de [Horde] (D032).*
