...
- [ ] Peuples à couvrir en V1 : **Gondor et ses fiefs** (rédigé, voir `02 - Factions/Gondor_et_Fiefs.md`), **Rohan** (rédigé et validé, voir `02 - Factions/Rohan.md`), **Khand** (rédigé et validé, voir `02 - Factions/Khand.md`), Mordor, Harad, Easterling
...
- [ ] **Playtest #1** — Gondor (trio 15 pts), Rohan (trio 13 pts) et Khand (roster complet, 5 profils) prêts à être testés
