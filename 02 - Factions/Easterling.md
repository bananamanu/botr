...
> **Objet de ce document :** Profils de troupes pour le peuple Easterling (4 unités, liste fournie par Emmanuel), en réponse à la tâche Todoist « Rédiger les profils d'unités — Easterling » (due 22/07, P1 — traitée en avance le 20/07). **Roster validé et clos (D038 du [[Document de cadrage]]) dès la première session**, sans passe de repasse ultérieure : les 4 décisions de contenu ont été tranchées avec Emmanuel dans la foulée de la discussion de philosophie d'armée. Prêt pour le Playtest #1.
>
...
- **Mouvement** : 2 pour l'Infanterie (D022) — **une exception** : Cataphractaires orientaux (Mouvement 2 au lieu de 3, cavalerie volontairement lente et lourde).
- **Portée de tir** : 4 hexagones pour l'unité de tir (D020).
- **Règles spéciales** : 1 à 2 par profil, cohérent avec la convention D023 (pas d'unité légendaire dans ce roster resserré à 4 profils).
...
**Note narrative :** les peuples de l'Est, alliés de longue date de Sauron, envoyés en renfort au Pelennor sous leurs propres bannières. Une infanterie de ligne disciplinée, qui avance en rangs serrés et referme ses boucliers au contact — [Mur de bouclier] : tant qu'elle reste au coude à coude avec une autre unité d'Infanterie amie, elle bénéficie de [Protection 1]. Rompre la ligne, c'est perdre cette protection.

> 🔗 **Voir aussi** [[Regles_Speciales]] — [Mur de bouclier] (D037) · [Protection X]
...
**Note narrative :** des archers de l'Est, formés à déverser des volées coordonnées plutôt qu'à harceler en mouvement — [Double Tir] : s'ils ne se sont pas déplacés, ils tirent deux fois. Contraste direct avec les archers mobiles de Rohan et Mordor ([Mobilité X]) : ici, la discipline vient de la ligne qui tient sa position et frappe deux fois plus fort, pas de la manœuvre.

> 🔗 **Voir aussi** [[Regles_Speciales]] — [Double Tir] *(première assignation en V1)*
...
|---|---|
| [Mur de bouclier] *(nouvelle, D037)* | Cohorte d'orientaux (1) · Cohorte de piquiers orientaux (2) |
...
## 5. Nouvelle règle créée pour ce roster — [Mur de bouclier]

Voir le détail complet dans [[Regles_Speciales]] (D037). Résumé :

**[Mur de bouclier]** *(Défensif)* : tant que cette unité est adjacente à au moins une autre unité d'**Infanterie amie**, elle bénéficie de **[Protection 1]** (ignore 1 touche après décompte des dégâts, quelle que soit la source — mêlée ou tir).

- **Différence avec [Protection X]** : [Protection X] est liée au terrain (bâtiment, fortification) ; [Mur de bouclier] est liée à la **formation** — perdue dès que l'unité se retrouve isolée de toute autre Infanterie amie.
- **Coût provisoire** : 1 point forfaitaire, aligné sur le tarif de [Protection 1] dans la table existante (1×X) — non testé en partie réelle, à surveiller au Playtest #1 comme les coûts de [Horde] et [Peur X].

---

## 6. Points restants — non bloquants pour le Playtest #1

Rien ne bloque le lancement du Playtest #1. À surveiller, même statut que [Horde]/[Peur X] pour Mordor à leur clôture :

1. **Coût de [Mur de bouclier]** (1 pt forfaitaire) — première assignation réelle, jamais testée. Piste de correction si trop généreux : en formation de ligne classique, la condition d'adjacence sera presque toujours vraie, ce qui en fait presque un [Armure 1] permanent pour 1 pt au lieu de 2 — à surveiller en priorité.
2. **Aucune unité composite** nommée dans ce roster — le point ouvert de [[Regles_Points]] §5 reste sans objet pour Easterling.
3. **Dominance assumée piquiers > cohorte de base** (6 vs 5 pts, D025) — cohérent avec le principe d'asymétrie déjà accepté pour les autres peuples, pas un défaut à corriger.
